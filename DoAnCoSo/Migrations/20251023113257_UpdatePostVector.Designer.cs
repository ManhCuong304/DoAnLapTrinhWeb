...
namespace DoAnCoSo.Migrations
{
    ...
    [Migration("20251023113257_UpdatePostVector")]
    partial class UpdatePostVector
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DoAnCoSo.Models.Follow", b =>
                {
            ...
            modelBuilder.Entity("DoAnCoSo.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DoAnCoSo.Models.Follow", b =>
                {
                    b.HasOne("DoAnCoSo.Models.ApplicationUser", "Follower")
                        .WithMany("Followings")
                        .HasForeignKey("FollowerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DoAnCoSo.Models.ApplicationUser", "Following")
                        .WithMany("Followers")
            ...
            modelBuilder.Entity("DoAnCoSo.Models.Message", b =>
                {
                    b.HasOne("DoAnCoSo.Models.ApplicationUser", "FromUser")
                        .WithMany()
                        .HasForeignKey("FromUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DoAnCoSo.Models.ApplicationUser", "ToUser")
                        .WithMany()
